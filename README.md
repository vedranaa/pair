...
Extension of the [https://docs.python.org/3/library/socket.html](`socket.socket`) class with functionality usefull for sending data between two computers on the same (wireless) network.
